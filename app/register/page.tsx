...
export default function RegisterPage() {
  ...
  const { register, isLoading, error, clearAuthError } = useAppStore()
      ...
      <div className="w-full max-w-md">
        ...
        <Card className="shadow-xl border-0 bg-white/80 backdrop-blur-sm">
          <CardHeader className="text-center">
            <CardTitle className="text-2xl font-bold text-gray-800">Join TravelHub</CardTitle>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className={`transition-all duration-300 ${errors.username ? "border-red-500 focus:border-red-500" : "focus:border-blue-500"}`}
                />
